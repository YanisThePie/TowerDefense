...
public class PseudoVolumetricExplosion : MonoBehaviour {
	...
	void Update () {
        ...
        gameObject.GetComponent<Renderer>().material.SetVector("_Range", new Vector4(beginRange, endRange, 0, 0));
        gameObject.GetComponent<Renderer>().material.SetFloat("_ClipRange", clipVal);
	}
}
